...
const char_t CTL_BOARD[] = "~HyperDriveSTM_GENERATED_INVERTER_CONFIG";
static const char_t M1_PWR_BOARD[] = "~HyperDriveSTM_GENERATED_INVERTER_CONFIG";
