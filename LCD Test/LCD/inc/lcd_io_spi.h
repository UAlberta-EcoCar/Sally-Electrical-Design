...
#define LCD_RST           0  /* If not used leave it that way */
#define LCD_RS            LCD_RESET_Pin

#define LCD_CS            LCD_CS_Pin
#define LCD_SCK           LCD_SCK_Pin
#define LCD_MOSI          LCD_MOSI_Pin
#define LCD_MISO          0  /* If not used leave it that way */

/* Backlight control
   - BL: A..K, 0..15 (if not used -> X, 0)
   - BL_ON: the logical level of the active state */
#define LCD_BL            0  /* If not used leave it that way */
